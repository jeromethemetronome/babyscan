function [ datas ] = diagnostique( tete_3D , xd,yd,zd, xg,yg,zg, xn,yn,zn, xod,yod,zod, xog,yog,zog, d_yeux_vrai )
...
datas = cell(nbr_coupe,7); % 1 colonne pour le résultat de per_tot (premier resultat de calcul_per), 1 pour la surface totale, 1 pour la position de la coupe (= ref) et 4 pour les 4 rapports qu'on va calculer
for i = 1:nbr_coupe
